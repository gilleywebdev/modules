		...
		<div class="wrapper">
			...
			<div class="content">
				<div class="header clear">
					...
					<h3 class="user_info">Logged in as <a href="/admin/user/profile" title="User" class="user_info_link"><?php echo $user->username ?></a>. <a href="/admin/auth/logout" class="user_info_link">Log out</a></h3>
				</div>
