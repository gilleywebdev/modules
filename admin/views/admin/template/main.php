		...
		<div class="wrapper">
			...
			<div class="content">
				<div class="header clear">
					...
					<h3 class="user_info">Logged in as <a href="/admin/user/profile" title="User" class="user_info_link">chris</a>. <a href="/admin/user/logout" class="user_info_link">Log out</a></h3>
				</div>
